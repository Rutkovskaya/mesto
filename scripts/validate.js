//Показывалка ошибок
const showInputError = (inputElement, errorMassage,sectionClass,inputErrorClass,errorClass) => {
...
//Скрывалка ошибок
const hideInputError = (inputElement,sectionClass,inputErrorClass,errorClass) => {
  const formSectionElement = inputElement.closest(sectionClass);
  const errorElement = formSectionElement.querySelector(inputErrorClass);
...
const checkInputValidity = (inputElement,inputNotValidClass,sectionClass,inputErrorClass,errorClass) => {
  ...
  if (isInputNotValid) {
    ...
    showInputError(inputElement, errorMassage,sectionClass,inputErrorClass,errorClass);
    inputElement.classList.add(inputNotValidClass);
  } else {

    hideInputError(inputElement,sectionClass,inputErrorClass,errorClass);
